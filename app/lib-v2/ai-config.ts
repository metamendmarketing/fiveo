...
Field rules:
- selectionStrategy: 30-40 words. Specific to vehicle, goal, and flow. No filler.
...
- preferenceSummary: One sentence, max 15 words.
- technicalNarrative: 40-60 words. Concise sentences. Cover fitment, flow match, and specific tuning/compatibility notes.
- proTip: One specific practical sentence, 15-20 words. NEVER use generic placeholders. Give a real shop-tip specific to this part or build.
