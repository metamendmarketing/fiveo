...
import { calculateRequiredCC, parseCylinders, parseProductSetSize, isDirectInjectionVehicle, isProductDI } from "@/app/lib-v2/constants";
import { Product, ScoredProduct } from "@/app/lib-v2/types";
