...
import { getServerSupabase } from "@/app/lib-v2/supabase";
import { getVertexModel } from "@/app/lib-v2/gemini";
import {
  type BuildProfile,
  calculateRequiredCC,
} from "@/app/lib-v2/constants";
import { scoreProducts, deduplicateResults } from "@/app/lib-v2/scoring";
import { Product, ScoredProduct, FitmentRecord, OracleApiResponse } from "@/app/lib-v2/types";
import rules from "@/app/lib-v2/scoring-rules.json";
import { ACTIVE_PERSONA } from "@/app/lib-v2/ai-config";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const { parseCylinders } = require("@/app/lib-v2/constants");
