...
- technicalNarrative: 80-120 words. Short sentences. Use decisive, expert language (e.g., "This is the clear choice" or "The engineering specs here are exactly what you need"). Cover fitment, flow match/tradeoff, tuning/compatibility warning if needed, and a confident close.
